<header class="mt-8.5 ps-5">
  ...
  <p class="text-gray-400 text-xs sm:text-sm text-justify leading-4 lg:leading-5">
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae quae dignissimos tenetur maxime, quas ducimus a maiores. Corrupti, quia quibusdam? Soluta dolor temporibus doloremque architecto!
  </p>
</header>